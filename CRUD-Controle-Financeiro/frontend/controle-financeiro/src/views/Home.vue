...
import ReceitasDiaria from "../components/home/ReceitasDiaria.vue";
import Navbar from "../components/Navbar.vue";
</script>

<template>
  <div>
    <Navbar userName="Igor Gabriel" :isHistorico="isHistorico" />
    <!-- Saldo da Conta -->
    <Container>
    ...
    <!-- Despesas Diarias-->
    <Container>
      <Titulo title="Despesas do dia" />
      <DespesasDiaria />
    </Container>

    <!-- Receitas Diarias -->
    <Container>
      <Titulo title="Receitas do dia" />
      <ReceitasDiaria />
    </Container>
  </div>
</template>
